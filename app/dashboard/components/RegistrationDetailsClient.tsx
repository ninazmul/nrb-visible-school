...
export default function RegistrationDetailsClient({
  ...
  const handlePrint = () => {
    ...
    <html>
      ...
      <body>
        <header>
          <img src="${settings?.logo || "/assets/images/logo.webp"}" alt="Institute Logo"/>
        ...
        <div class="student-info">
          ...
          <div class="photo-container">
            <img src="${registration.photo || "/assets/images/placeholder.webp"}" alt="Student Photo"/>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="w-full aspect-square rounded-xl overflow-hidden bg-gray-50 dark:bg-gray-800 flex items-center justify-center border border-gray-100 dark:border-gray-800">
                <Image
                  src={registration.photo || "/assets/images/placeholder.webp"}
